      ...
      render(){
        const users_list = this.state.list.map((item, key) =>
            ...
            <td>
              {item.level >= 1 ||
                <span>
                  <button className="btn btn-outline-info" type="button" style={{marginLeft:'5px'}} onClick={this.logout}>+</button>
                  <button className="btn btn-outline-info" type="button" style={{marginLeft:'5px'}} onClick={this.logout}>-</button>
                  <button className="btn btn-outline-info" type="button" style={{marginLeft:'5px'}} onClick={this.logout}>
